...
public class AccountDAO {
    ...
    public static void insert(Account account) throws SQLException{
            ...
            )
        {
            ...
            stm.setString(3, account.getHashedPassword());
            stm.setString(4, account.getOtp());
            stm.setTimestamp(5, account.getOtpExpiredDate() != null ? Timestamp.valueOf(account.getOtpExpiredDate()) : null);
            
            stm.setInt(6, account.getUnreadNotification());
            stm.setInt(7, account.getRoleId());
            stm.setTimestamp(8, account.getCreatedAt() != null ? Timestamp.valueOf(account.getCreatedAt()) : null);
            stm.setBoolean(9, account.isActive());
