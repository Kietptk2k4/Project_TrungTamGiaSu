...
//             Trung tâm DSTK  kết nối bạn với gia sư chất lượng cao, giúp con bạn đạt kết quả học tập tốt nhất.
//           </p>
...
//           <h2 className="text-black font-bold text-center mb-12">Cách thức hoạt động</h2>
          
//           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
//             <div className="text-center">
//               <div className="bg-primary text-black w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">1</div>
...
//             <div className="text-center">
//               <div className="bg-primary text-black w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">2</div>
...
//             <div className="text-center">
//               <div className="bg-primary text-black w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">3</div>
...
//                 "Con tôi đã tiến bộ rất nhiều nhờ gia sư từ Trung tâm DSTK . Chỉ sau 3 tháng, điểm số của con đã tăng đáng kể."
//               </p>
...
//               </div>
//               <p className="text-gray-600 mb-4">
//                 "Tôi rất hài lòng với dịch vụ của Trung tâm DSTK . Việc tìm gia sư trở nên dễ dàng và gia sư rất chuyên nghiệp."
//               </p>
...
const Home = () => {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-6">Trung tâm DSTK  - Kết nối gia sư</h1>
